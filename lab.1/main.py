...
def read_text_from_file(filename):
    ...
    try:
        ...
        # Текст по умолчанию, если файл не найден
        return """Квантовая механика представляет собой фундаментальную теорию физики, 
которая описывает природу на уровне атомов и субатомных частиц."""

TEXT = read_text_from_file('text_data.txt')
